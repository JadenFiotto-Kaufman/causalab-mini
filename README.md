...
| [`documents/v2/`](documents/v2/) | the plan-shaped format: patching, DAS, mean ablation, zero ablation, a window, an entity harvest, a logit lens, generation, a PCA control, DBM |
